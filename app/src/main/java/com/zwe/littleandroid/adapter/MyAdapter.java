package com.zwe.littleandroid.adapter;
...
import com.zwe.littleandroid.R;
...
public class MyAdapter extends BaseAdapter{
    ...
    public MyAdapter(Context context, List<ChatMessage> mDatas)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null)
        {
            ...
            {
                convertView = mInflater.inflate(R.layout.item_form_msg, parent,
                        false);
